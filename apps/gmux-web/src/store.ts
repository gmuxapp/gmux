...
export async function killSession(sessionId: string): Promise<void> {
  await postAction(`/v1/sessions/${sessionId}/kill`, 'Kill')
}
...
export async function resumeSession(sessionId: string): Promise<void> {
  await postAction(`/v1/sessions/${sessionId}/resume`, 'Resume')
}

export async function restartSession(sessionId: string): Promise<void> {
  await postAction(`/v1/sessions/${sessionId}/restart`, 'Restart')
}
