...
export const DEMO_ACTIVITY: MockSession[] = [
  demo({
    ...
    unread: true, last_activity_at: ago(3),
  }),
  demo({
    ...
    unread: true, last_activity_at: ago(14),
  }),
  demo({
    id: 'sess-demo-working', title: 'migrate settings schema',
    status: { working: true }, last_activity_at: ago(1), mockActive: true,
  }),
  demo({
